package com.pik.smartcity.slidinguppanel;
 ...
 * @Package :com.ypyproductions.slidinguppanel
 */
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs, com.pik.smartcity.R.styleable.SlidingUpPanelLayout);

            if (ta != null) {
                mPanelHeight = ta.getDimensionPixelSize(com.pik.smartcity.R.styleable.SlidingUpPanelLayout_collapsedHeight, -1);
                mShadowHeight = ta.getDimensionPixelSize(com.pik.smartcity.R.styleable.SlidingUpPanelLayout_shadowHeight, -1);

                mMinFlingVelocity = ta.getInt(com.pik.smartcity.R.styleable.SlidingUpPanelLayout_flingVelocity, DEFAULT_MIN_FLING_VELOCITY);
                mCoveredFadeColor = ta.getColor(com.pik.smartcity.R.styleable.SlidingUpPanelLayout_fadeColor, DEFAULT_FADE_COLOR);

                mDragViewResId = ta.getResourceId(com.pik.smartcity.R.styleable.SlidingUpPanelLayout_dragView, -1);
            }
