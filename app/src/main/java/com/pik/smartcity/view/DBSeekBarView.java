package com.pik.smartcity.view;
...
public class DBSeekBarView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSlideBar != null) {
            ...
            mRectSlide.right = mRectSlide.left + mSlideBar.getWidth();
            mRectSlide.top = (int) slideBgY;
            mRectSlide.bottom = mRectSlide.top + mSlideBar.getHeight();
    ...
    public void setProgress(int progress, boolean isAffected) {
        ...
        if (orientation == HORIZONTAL) {
            float x = (float) progress / maxProgress * (float) mWidthToCalculateProcess;
            this.mThumbX = (int) (mThumbMinX + x);
        } else if (orientation == VERTICAL) {
            float y = (float) progress / maxProgress * (float) mHeightToCalculateProcess;
    ...
    public interface OnSeekBarChangeListener {
        void onSeekBarChangeListener(int process);
