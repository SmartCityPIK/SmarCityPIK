...
import com.pik.smartcity.object.ItemDrawerObject;
...
public class DrawerAdapter extends BaseAdapter implements IWhereMyLocationConstants {
    ...
    public DrawerAdapter(Context mContext,
                         ArrayList<ItemDrawerObject> listDrawerObjects,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(com.pik.smartcity.R.layout.item_drawer, null);
            convertView.setTag(mHolder);
        } else {
            mHolder = (ViewHolder) convertView.getTag();
        }

        mHolder.mTvNameDrawer = (TextView) convertView.findViewById(com.pik.smartcity.R.id.tv_name_setting);
        mHolder.mDevider = convertView.findViewById(com.pik.smartcity.R.id.devider);
