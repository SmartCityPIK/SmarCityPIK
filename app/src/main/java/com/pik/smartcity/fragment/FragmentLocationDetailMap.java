...
import com.pik.smartcity.adapter.MapInfoAdapter;
import com.pik.smartcity.constanst.IWhereMyLocationConstants;
import com.pik.smartcity.dataMng.TotalDataManager;
import com.pik.smartcity.dataMng.YPYNetUtils;
import com.pik.smartcity.location.DBLastLocationFinder;
import com.pik.smartcity.object.PlaceDetailObject;
import com.pik.smartcity.object.PlaceObject;
import com.pik.smartcity.object.RouteObject;
import com.pik.smartcity.object.StepObject;
import com.pik.smartcity.settings.SettingManager;
import com.pik.smartcity.slidinguppanel.SlidingUpPanelLayout;
...
public class FragmentLocationDetailMap extends SupportMapFragment implements IWhereMyLocationConstants, IDBConstantURL {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mRootView = (RelativeLayout) inflater.inflate(com.pik.smartcity.R.layout.fragment_location_detail_map, container, false);
        this.mSlideLayout = (SlidingUpPanelLayout) mRootView.findViewById(com.pik.smartcity.R.id.layout_slidingup);
    ...
    private void findView() {
        ...
        this.mTvDistanceDuration = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_duration_distance);
        this.mTvSummary = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_sumary);
        this.mLayoutListDirections = (LinearLayout) mRootView.findViewById(com.pik.smartcity.R.id.list_directions);
        this.mImgIndicator = (ImageView) mRootView.findViewById(com.pik.smartcity.R.id.img_indicator);
        ...
        this.mSlideLayout.setDragView(mRootView.findViewById(com.pik.smartcity.R.id.layout_info));
        this.mSlideLayout.setPanelSlideListener(new SlidingUpPanelLayout.PanelSlideListener() {
            ...
            public void onPanelExpanded(View panel) {
                ...
                mImgIndicator.setImageResource(com.pik.smartcity.R.drawable.ic_action_expand);
            ...
            public void onPanelCollapsed(View panel) {
                ...
                mImgIndicator.setImageResource(com.pik.smartcity.R.drawable.ic_action_collapse);
    ...
    private void setUpInfoForSlidingPanel() {
        ...
        if (mRoutObject == null) {
            ...
            if (metric.equals(UNIT_KILOMETTER)) {
                ...
                float convertDistance = Math.round(mCurrentPlaceObject.getDistance() / ONE_MILE);
        ...
        String mInfoDistanceDuration = String.format(getString(com.pik.smartcity.R.string.format_duration_distance), duration, distance);
        mTvDistanceDuration.setText(Html.fromHtml(mInfoDistanceDuration));

        if (!StringUtils.isStringEmpty(mRoutObject.getSummary())) {
            String mInfoSummary = String.format(getString(com.pik.smartcity.R.string.format_sumary), mRoutObject.getSummary());
        ...
        if (mListStepObject != null && mListStepObject.size() > 0) {
            ...
            addItemDirections(getString(com.pik.smartcity.R.string.title_my_location), "", com.pik.smartcity.R.drawable.ic_launcher);
        ...
        if (mRoutObject == null) {
            ...
            DBTask mDbTask = new DBTask(new IDBTaskListener() {
                ...
                public void onPreExcute() {
                    mContext.showProgressDialog(String.format(getString(com.pik.smartcity.R.string.info_format_process_detail_location), mCurrentPlaceObject.getName()));
                }
                ...
                public void onPostExcute() {
                    ...
                    if (mRoutObject == null) {
                        mContext.showToast(com.pik.smartcity.R.string.info_server_error);
                        return;
                    }
    ...
    public void setUpMap() {
        ...
        mCurrentLocationMarker = new MarkerOptions().position(mCurrentLatLng).title(mContext.getString(com.pik.smartcity.R.string.title_my_location)).snippet(mLocationName)
                .icon(BitmapDescriptorFactory.fromResource(com.pik.smartcity.R.drawable.icon_my_location));
    ...
    private void addItemDirections(String description, String distance, int resIconId) {
        RelativeLayout mRelativeLayout = (RelativeLayout) LayoutInflater.from(mContext).inflate(com.pik.smartcity.R.layout.item_directions, null);
        TextView mTvDes = (TextView) mRelativeLayout.findViewById(com.pik.smartcity.R.id.tv_descriptions);
        TextView mTvDistance = (TextView) mRelativeLayout.findViewById(com.pik.smartcity.R.id.tv_distance);
                ...
                if (StringUtils.isStringEmpty(mLocationName)) {
                    IDBTaskListener mDBTaskListener = new IDBTaskListener() {
                        ...
                        public void onDoInBackground() {
                            ...
                            if (StringUtils.isStringEmpty(mLocationName)) {
                                mLocationName = getString(com.pik.smartcity.R.string.title_unknown_location);
                            }
                        }
