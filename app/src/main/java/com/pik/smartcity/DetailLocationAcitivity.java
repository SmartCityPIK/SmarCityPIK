...
import com.pik.smartcity.fragment.FragmentLocationDetailInfomation;
import com.pik.smartcity.fragment.FragmentLocationDetailMap;
...
import com.pik.smartcity.object.ResponcePlaceResult;
...
public class DetailLocationAcitivity extends DBFragmentActivity implements OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mIt != null) {
            ...
            mStartFrom = mIt.getStringExtra(IWhereMyLocationConstants.KEY_START_FROM);
        }
    ...
    */
    private void initLocationObject() {
        if (!mStartFrom.equals(IWhereMyLocationConstants.START_FROM_MAIN)) {
    ...
    private void backToHome() {
        if (mStartFrom != null && !mStartFrom.equals(IWhereMyLocationConstants.START_FROM_SEARCH)) {
            if (mStartFrom.equals(IWhereMyLocationConstants.START_FROM_TOTAL_PLACE)) {
                finish();
            } else if (mStartFrom.equals(IWhereMyLocationConstants.START_FROM_MAIN)) {
                Intent mIntent = new Intent(this, MainActivity.class);
                mIntent.putExtra(IWhereMyLocationConstants.KEY_START_FROM, IWhereMyLocationConstants.START_FROM_DETAIL);
