...
import com.pik.smartcity.view.DBSeekBarView;
...
public class FragmentSettings extends Fragment implements IWhereMyLocationConstants {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(com.pik.smartcity.R.layout.fragment_settings, container, false);
        return mRootView;
    }
    ...
    private void findView() {
        ...
        this.mTvInfoRadius = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_radius);
        this.mTvMinRadius = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_min_radius);
        this.mTvMaxRadius = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_max_radius);

        this.mTvTitleMetric = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_title_metric);
        this.mTvTitlePiority = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_title_piority);
        this.mTvTitleTravelMode = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_title_travel_mode);

        this.mTvMetric = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_metric);
        this.mTvPiority = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_piority);
        this.mTvTravelMode = (TextView) mRootView.findViewById(com.pik.smartcity.R.id.tv_travel_mode);
        ...
        this.mDBSeekbar = (DBSeekBarView) mRootView.findViewById(com.pik.smartcity.R.id.dBSeekBarView1);
        this.mDBSeekbar.setOnSeekBarChangeListener(new DBSeekBarView.OnSeekBarChangeListener() {
        ...
        RelativeLayout mLayoutMetric = (RelativeLayout) mContext.findViewById(com.pik.smartcity.R.id.layout_metric);
        RelativeLayout mLayoutPiority = (RelativeLayout) mContext.findViewById(com.pik.smartcity.R.id.layout_piority);
        RelativeLayout mLayoutTravelModes = (RelativeLayout) mContext.findViewById(com.pik.smartcity.R.id.layout_travel_mode);
        ...
        if (piority.equals(PIORITY_DISTANCE)) {
            mTvPiority.setText(getString(com.pik.smartcity.R.string.title_distance));
        } else if (piority.equals(PIORITY_RATING)) {
            mTvPiority.setText(getString(com.pik.smartcity.R.string.title_rating));
        }
    ...
    private void updateInfoRadius(int process, boolean isInit) {
        if (SettingManager.getMetric(mContext).equals(UNIT_KILOMETTER)) {
            mTvInfoRadius.setText(String.format(mContext.getString(com.pik.smartcity.R.string.format_radius), process, "km"));
            if (isInit) {
            ...
            mTvInfoRadius.setText(String.format(mContext.getString(com.pik.smartcity.R.string.format_radius), miles, "mi"));
            if (isInit) {
    ...
    private void showPopupPiority() {
        ...
        mBuilder.setTitle(com.pik.smartcity.R.string.title_piority);
        mBuilder.setSingleChoiceItems(com.pik.smartcity.R.array.sorting_array, selected, new DialogInterface.OnClickListener() {
    ...
    private void showPopupMetric() {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(mContext);
        mBuilder.setTitle(com.pik.smartcity.R.string.title_units);
        mBuilder.setSingleChoiceItems(com.pik.smartcity.R.array.metric_array, selected, new DialogInterface.OnClickListener() {
    ...
    private void showTravelMode() {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(mContext);
        mBuilder.setTitle(com.pik.smartcity.R.string.title_travel_modes);
        mBuilder.setSingleChoiceItems(com.pik.smartcity.R.array.travel_mode_array, selected, new DialogInterface.OnClickListener() {
