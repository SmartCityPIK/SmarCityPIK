...
public class HomeAdapter extends BaseAdapter implements IWhereMyLocationConstants {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(com.pik.smartcity.R.layout.item_home, null);
            convertView.setTag(mHolder);
        } else {
            mHolder = (ViewHolder) convertView.getTag();
        }
        mHolder.mTvName = (TextView) convertView.findViewById(com.pik.smartcity.R.id.tv_name);
        mHolder.mImgIcon = (ImageView) convertView.findViewById(com.pik.smartcity.R.id.img_icon);
        mHolder.mImgIndicator = (ImageView) convertView.findViewById(com.pik.smartcity.R.id.img_indicator);
