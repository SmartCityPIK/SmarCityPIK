 ...
 */
public class WebviewActivity extends DBFragmentActivity implements IWhereMyLocationConstants {
...
*/
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent mIntent = new Intent(WebviewActivity.this, WeatherActivity.class);
            mIntent.putExtra(KEY_START_FROM, START_FROM_MAIN);

            DirectionUtils.changeActivity(WebviewActivity.this, R.anim.slide_in_from_right, R.anim.slide_out_to_left, true, mIntent);
